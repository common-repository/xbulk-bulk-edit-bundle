...
<div class="wccbel-modal" id="wccbel-modal-used-in">
        ...
        <div class="wccbel-modal-box wccbel-modal-box-sm">
            <div class="wccbel-modal-content">
                <div class="wccbel-modal-title">
                    <h2><?php esc_html_e('Used in', 'ithemeland-woocommerce-bulk-coupons-editing-lite'); ?> <span id="wccbel-modal-used-in-item-title" class="wccbel-modal-item-title"></span></h2>
                ...
                <div class="wccbel-modal-body">
                    <div class="wccbel-wrap">
                        <div class="wccbel-col-full" id="wccbel-modal-coupon-used-in-items">
