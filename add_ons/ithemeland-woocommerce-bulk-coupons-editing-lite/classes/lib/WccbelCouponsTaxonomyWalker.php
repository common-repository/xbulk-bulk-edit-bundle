...
namespace wccbel\classes\lib;

defined('ABSPATH') || exit(); // Exit if accessed directly

class WccbelCouponsTaxonomyWalker extends \Walker_Category
{
    var $lev = -1;
    var $skip = 0;
    private $checked;
    ...
    function start_el(&$output, $category, $depth = 0, $args = array(), $id = 0)
    {
        ...
        $category_id = ($category->taxonomy != 'coupon_tag') ? sanitize_text_field(intval($category->term_id)) : sanitize_text_field($category->slug);
