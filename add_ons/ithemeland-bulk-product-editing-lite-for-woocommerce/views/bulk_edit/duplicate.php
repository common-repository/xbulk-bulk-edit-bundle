        ...
        <div class="wcbef-modal-box wcbef-modal-box-sm">
            <div class="wcbef-modal-content">
                <div class="wcbef-modal-title">
                    <h2><?php esc_html_e('Product Duplicate', 'woocommerce-bulk-edit-free'); ?></h2>
                    ...
                    <div class="wcbef-wrap">
                        <div class="wcbef-filters-form-group">
                            <label class="wcbef-label-big" for="wcbef-bulk-edit-duplicate-number">
                                <?php esc_html_e('Enter how many product(s) to Duplicate!', 'woocommerce-bulk-edit-free'); ?>
                            </label>
                            <input type="number" class="wcbef-input-numeric-sm" id="wcbef-bulk-edit-duplicate-number" value="1" placeholder="<?php esc_html_e('Number ...', 'woocommerce-bulk-edit-free'); ?>">
                        </div>
                    </div>
                </div>
                <div class="wcbef-modal-footer">
                    <button type="button" class="wcbef-button wcbef-button-blue" id="wcbef-bulk-edit-duplicate-start">
                        <?php esc_html_e('Start Duplicate', 'woocommerce-bulk-edit-free'); ?>
                    </button>
                </div>
            </div>
        </div>
