...
namespace wcbef\classes\services\product_update;

use wcbef\classes\repositories\History;
use wcbef\classes\services\product_update\handlers\Meta_Field_Handler;
use wcbef\classes\services\product_update\handlers\Product_Action_Handler;
use wcbef\classes\services\product_update\handlers\Remove_Duplicate_Handler;
use wcbef\classes\services\product_update\handlers\Taxonomy_Handler;
use wcbef\classes\services\product_update\handlers\Woocommerce_Handler;
use wcbef\classes\services\product_update\handlers\WP_Posts_Handler;

class Product_Update_Service
{
    ...
    private function save_history()
    {
        ...
        $history_id = $history_repository->create_history([
            ...
            'operation_type' => (count($this->product_data) > 1) ? History::BULK_OPERATION : History::INLINE_OPERATION,
