...
class History
{
    ...
    {
        return [
            self::BULK_OPERATION => __('Bulk Operation', 'ithemeland-bulk-product-editing-lite-for-woocommerce'),
            self::INLINE_OPERATION => __('Inline Operation', 'ithemeland-bulk-product-editing-lite-for-woocommerce'),
        ];
    }
    ...
    public function revert($history_id)
    {
        ...
        foreach ($history_items as $item) {
            ...
            $update_service->set_update_data([
                'update_type' => ($field['name'] == 'bulk_variation_update') ? 'variation' : 'product',
