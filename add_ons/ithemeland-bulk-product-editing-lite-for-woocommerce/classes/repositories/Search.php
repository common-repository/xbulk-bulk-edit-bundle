...
class Search
{
    private $filter_profile_option_name = "wcbel_filter_profile";
    private $use_always_table = "wcbel_filter_profile_use_always";
    private $current_data_option_name = "wcbel_filter_profile_current_data";
    ...
    public function set_default_item()
    {
        $default_item['default'] = [
            'name' => esc_html__('All Products', 'ithemeland-bulk-product-editing-lite-for-woocommerce'),
