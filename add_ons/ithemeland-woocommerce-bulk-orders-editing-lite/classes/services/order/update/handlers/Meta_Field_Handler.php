...
class Meta_Field_Handler implements Handler_Interface
{
    ...
    public function update($order_ids, $update_data)
    {
        ...
        foreach ($this->order_ids as $order_id) {
            ...
            $this->current_field_value = (!empty($this->update_data['name'])) ? $this->order->get_meta($this->update_data['name']) : '';
    ...
    private function set_default_meta_field()
    {
        ...
        $this->order->update_meta_data($this->update_data['name'], $this->update_data['value']);
