...
class Tab_Repository
{
    ...
    {
        $this->meta_field_repository = Meta_Field::get_instance();
            ...
            'other_fields' => [
                ...
                'fields' => [
                    'created_via' => [
                        ...
                        'html' => [
                            Generator::label_field(['for' => 'wobel-bulk-edit-form-order-created-via'], esc_html__('Created Via', 'ithemeland-woocommerce-bulk-orders-editing-lite')),
                            Generator::input_field([
                                'class' => 'wobel-input-md',
                                'id' => 'wobel-bulk-edit-form-order-created-via',
                                'data-field' => 'value',
                                'placeholder' => esc_html__('Created Via ...', 'ithemeland-woocommerce-bulk-orders-editing-lite')
                            ]),
                        ]
                    ],
                    'payment_method' => [
    ...
    public function get_filter_form_tabs_content()
    {
        ...
        return [
            ...
            'filter_other_fields' => [
                ...
                'fields' => [
                    'created_via' => [
                        Generator::label_field(['for' => 'wobel-filter-form-order-created-via'], esc_html__('Created Via', 'ithemeland-woocommerce-bulk-orders-editing-lite')),
                        Generator::select_field([
                            'id' => 'wobel-filter-form-order-created-via-operator',
                            'data-field' => 'operator',
                            'title' => esc_html__('Select Operator', 'ithemeland-woocommerce-bulk-orders-editing-lite')
                        ], Operator::filter_text()),
                        Generator::input_field([
                            'style' => 'height: 34px;',
                            'class' => 'wobel-input-md',
                            'id' => 'wobel-filter-form-order-created-via',
                            'data-field' => 'value',
                            'placeholder' => esc_html__('Created Via ...', 'ithemeland-woocommerce-bulk-orders-editing-lite')
                        ])
                    ],
