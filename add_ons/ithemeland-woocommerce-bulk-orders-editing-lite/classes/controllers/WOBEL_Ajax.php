...
class WOBEL_Ajax
{
    ...
    {
        if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'wobel_ajax_nonce')) {
            die();
        }
    ...
    public function order_edit()
    {
        ...
        if (!empty($_POST['order_ids'])) {
            ...
            $order_ids = ($this->order_repository->get_orders($args))->orders;
        } else {
            return false;
        }
            ...
            switch ($_POST['delete_type']) {
                ...
                case 'all':
                    if (isset($_POST['filter_data'])) {
                        ...
                        if (!empty($order_ids)) {
                            foreach ($order_ids as $order_id) {
                                $order_object = wc_get_order(intval($order_id));
