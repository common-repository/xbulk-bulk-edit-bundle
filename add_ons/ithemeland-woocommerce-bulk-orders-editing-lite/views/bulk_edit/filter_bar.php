...
<div class="wobel-top-nav-filters">
    <div class="wobel-top-nav-filters-left">
        ...
        <div class="wobel-status-filter-container">
            <button type="button" class="wobel-status-filter-button" title="<?php esc_attr_e('Status Filter', 'ithemeland-woocommerce-bulk-orders-editing-lite'); ?>">
                <?php esc_html_e('Statuses', 'ithemeland-woocommerce-bulk-orders-editing-lite'); ?> <span class="wobel-status-filter-selected-name"></span>
