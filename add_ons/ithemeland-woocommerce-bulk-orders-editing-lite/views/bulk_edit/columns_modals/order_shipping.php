                ...
                <div class="wobel-modal-body">
                    <div class="wobel-wrap">
                        <div class="wobel-col-full wobel-mb20">
                            ...
                            <button type="button" class="wobel-modal-load-shipping-address" data-target="#wobel-modal-order-shipping" data-order-field="customer-user-id" data-customer-id=""><?php esc_html_e('Load shipping address', 'ithemeland-woocommerce-bulk-orders-editing-lite'); ?></button>
                            <span> | </span>
                            <button type="button" class="wobel-modal-load-billing-address" data-target="#wobel-modal-order-shipping" data-order-field="customer-user-id" data-customer-id=""><?php esc_html_e('Copy billing address', 'ithemeland-woocommerce-bulk-orders-editing-lite'); ?></button>
                        </div>
