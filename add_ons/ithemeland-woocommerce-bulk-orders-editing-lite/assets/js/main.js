...
jQuery(document).ready(function ($) {
    ...
    $(document).on("click", ".wobel-tabs-list li button.wobel-tab-item", function (event) {
    ...
    $(document).on('click', '.wobel-quick-filter > button', function (e) {
    ...
    $(document).on("keypress", function (e) {
        if (e.keyCode === 13) {
            ...
            if ($('#wobel-quick-search-text').val() !== '' && $($('#wobel-last-modal-opened').val()).css('display') !== 'block' && $('.wobel-tabs-list button[data-content=bulk-edit]').hasClass('selected')) {
                wobelReloadOrders();
