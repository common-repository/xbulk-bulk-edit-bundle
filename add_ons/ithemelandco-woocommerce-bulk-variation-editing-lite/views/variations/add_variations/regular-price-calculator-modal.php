...
?>
<div class="iwbvel-modal" id="iwbvel-modal-variations-regular-price">
        ...
        <div class="iwbvel-modal-box iwbvel-modal-box-sm">
            <div class="iwbvel-modal-content">
                <div class="iwbvel-modal-title">
                    <h2><?php esc_html_e('Calculator', 'ithemeland-woocommerce-bulk-variations-editing'); ?></h2>
                ...
                <div class="iwbvel-modal-footer">
                    <button type="button" data-item-id="" data-field="regular_price" data-name="regular_price" data-toggle="modal-close" class="iwbvel-button iwbvel-button-blue iwbvel-variations-price-calculator-apply-button">
