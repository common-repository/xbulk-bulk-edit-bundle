...
class Search
{
    ...
    {
        $this->filter_profile_option_name = "iwbvel_filter_profile";
        $this->use_always_table = "iwbvel_filter_profile_use_always";
        $this->current_data_option_name = "iwbvel_filter_profile_current_data";
    }
    ...
    public function set_default_item()
    {
        $default_item['default'] = [
            'name' => esc_html__('All Products', 'ithemelandco-woocommerce-bulk-variation-editing-lite'),
