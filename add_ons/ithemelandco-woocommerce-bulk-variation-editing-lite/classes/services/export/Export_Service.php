...
namespace iwbvel\classes\services\export;
...
class Export_Service
{
                    ...
                    foreach ($attributes as $attribute_name => $attribute) {
                        if (empty($this->columns[$attribute_name]) && is_a($attribute, 'WC_Product_Attribute')) {
                            $this->columns[$attribute_name] = [
                                'name' => $attribute_name,
                                'label' => sanitize_text_field(wc_attribute_label($attribute->get_name(), $product_object)),
    ...
    {
        $file_name = "iwbvel-product-export-" . time() . '.csv';
