...
class IWBVEL_Meta_Fields
{
    public function init()
    {
        add_filter('iwbvel_column_fields', [$this, 'add_meta_fields_to_column_manager']);
        add_filter('iwbvel_column_fields', [$this, 'add_attributes_to_column_manager']);
    }
