...
?>
        <tr>
            ...
            <td class="wpbel-fw600"><?php echo esc_html(gmdate('Y / m / d', strtotime($history->operation_date))); ?></td>
            <td>
                <button type="button" class="wpbel-button wpbel-button-blue" disabled="disabled">
                    <i class="wpbel-icon-rotate-cw"></i>
                    <?php esc_html_e('Revert', 'ithemeland-wordpress-bulk-posts-editing-lite'); ?>
                </button>
                <button type="button" class="wpbel-button wpbel-button-red" disabled="disabled">
