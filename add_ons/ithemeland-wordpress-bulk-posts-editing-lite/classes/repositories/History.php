...
class History
{
    ...
    {
        return [
            self::BULK_OPERATION => __('Bulk Operation', 'ithemeland-wordpress-bulk-posts-editing-lite'),
            self::INLINE_OPERATION => __('Inline Operation', 'ithemeland-wordpress-bulk-posts-editing-lite'),
        ];
    }
